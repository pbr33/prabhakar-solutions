...
class AzureAI:
    ...
    def _fb_mermaid(self, arch):
        ...
        deployment += "    CI -->|build + test| ART[ACR / Artifacts]\n"
        ...
        security += "    WAF[WAF / DDoS Protection]\n"
        security += "    FD2[Front Door + TLS]\n"
        security += "    APIM2[API Management + OAuth]\n"
        security += "    VNET[Virtual Network]\n"
        security += "    NSG[NSG Rules]\n"
        security += "    APP2[App Service + MI]\n"
        security += "    KV2[Key Vault]\n"
        security += "    SQL2[(SQL + TDE)]\n"
        security += "    LOG[Sentinel + Log Analytics]\n\n"
