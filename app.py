...
class AzureAI:
    ...
    def _fb_mermaid(self, arch):
        ...
        sequence += "    participant AzAD as Azure AD\n"
        ...
        sequence += "    API->>AzAD: Validate JWT\n"
        sequence += "    AzAD-->>API: Token Valid\n"
        ...
        deployment = "graph TD\n"
        deployment += "    DEV[\"Developer\"] -->|git push| REPO[\"Azure Repos\"]\n"
        deployment += "    REPO -->|trigger| BUILD[\"Build Pipeline\"]\n"
        deployment += "    BUILD -->|test| TEST[\"Unit and Integration Tests\"]\n"
        ...
        deployment += "    style STAGING fill:#FFF3E0,stroke:#E65100,color:#1a1a1a\n"
        deployment += "    style BUILD fill:#E3F2FD,stroke:#1565C0,color:#1a1a1a\n"
        deployment += "    style QA fill:#FCE4EC,stroke:#C62828,color:#1a1a1a"
        ...
        security += "    VNET --> SQL\n"
        security += "    VNET --> BLOB\n"
        security += "    APP --> LOG[\"Azure Sentinel\"]\n\n"
